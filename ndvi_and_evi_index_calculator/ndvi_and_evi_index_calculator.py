...
class NDVIandEVIindexCalculator:
    ...
    def run(self):
        ...
        self.dlg.checkBox.clicked.connect(self.raster_calculator_M_GDAL)
        self.dlg.checkBox_2.clicked.connect(self.raster_calculator_M)
    ...
    def raster_calculator_M(self):
        self.dlg.checkBox_2.setChecked(True)
        self.dlg.checkBox.setChecked(False)
        
    def raster_calculator_M_GDAL(self):
    ...
    def calculate_ndvi(self):
        ...
        if self.dlg.checkBox_2.isChecked():
            ...
            lyr0 = polygonLayerB08
            lyr1 = polygonLayerB04
            entries = []
            ...
            output = '{}/ndvi_{}.tiff'.format(myfilepath, dateName)
            calc = QgsRasterCalculator( '("ras1@1" -  "ras2@2") / ("ras1@1" + "ras2@2" )', output, 'GTiff', lyr0.extent(), lyr0.width(), lyr0.height(), entries )
    ...
    def calculate_evi(self):
        ...
        if self.dlg.checkBox_2.isChecked():
            ...
            output = '{}/evi_{}.tiff'.format(myfilepath, dateName)
            calc = QgsRasterCalculator('2.5* ((("ras1@1") -  ("ras2@2")) / (("ras1@1" + (6.0 * "ras2@2") - (7.5 * "ras3@3")) + 1.0))', output, 'GTiff', lyr0.extent(), lyr0.width(), lyr0.height(), entries )
            calc.processCalculation() 
